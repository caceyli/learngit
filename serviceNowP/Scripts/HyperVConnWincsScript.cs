...
namespace bdna.Scripts  {
    ...
    /// and default scopes.
    /// </summary>
    public class HyperVConnWincsScript : IConnectionScriptRuntime  {
        ...
        /// <param name="?"></param>
        /// <returns></returns>
        private IDictionary<string, string>[] reorderCredentials(IDictionary<string, string>[] connectionParameters)   {
