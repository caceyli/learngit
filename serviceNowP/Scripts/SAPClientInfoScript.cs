...
namespace bdna.Scripts {
    public class SAPClientInfoScript  : ICollectionScriptRuntime {
        ...
        private void BuildDataRow() {
            if (!m_attributes.ContainsKey(s_attributeName)) {
                Lib.Logger.TraceEvent(TraceEventType.Error,
                                      ...
                                      m_taskId,
                                      s_attributeName);
            } else if (String.IsNullOrEmpty(m_sapClientInfoProperties)) {
                Lib.Logger.TraceEvent(TraceEventType.Verbose,
                                      0,
                ...
                m_dataRow.Append(m_elementId).Append(',')
                         ...
                         .Append(m_sapClientInfoProperties)
        ...
        /// Collected Data
        /// </summary>
        private string m_sapClientInfoProperties = String.Empty;

        static string s_attributeName = @"__SAPClientDetails";
    }
}
